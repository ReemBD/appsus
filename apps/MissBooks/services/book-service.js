...
function _createBooks() {
    gBooks = storageService.load(KEY);
...
function addGoogleBook(googleBook) {
    if (!googleBook.volumeInfo.authors) googleBook.volumeInfo.authors = ['No Author'];
    if (!googleBook.volumeInfo.categories) googleBook.volumeInfo.categories = ['General'];
    ...
    gBooks = [formattedGoogleBook, ...gBooks];
    _saveBooksToStorage()
    return Promise.resolve(formattedGoogleBook)
}
